...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String WHERE_CHANGED_1 = " WHERE CHANGED=1";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String createClients = "CREATE TABLE CLIENT_TABLE (ID INT, " + FIRST_NAME +
                ...
                "CAREGIVER_CONTACT_NUMBER TEXT, PHOTO BLOB, CHANGED BOOL)";
        ...
        String createEducationAspect = "CREATE TABLE EDUCATION_ASPECT_TABLE (CLIENT_ID INT, " +
                "RATE_EDUCATION TEXT, DESCRIBE_EDUCATION TEXT, SET_GOAL_FOR_EDUCATION TEXT, CHANGED BOOL)";
        ...
        String createHealthAspect = "CREATE TABLE HEALTH_ASPECT_TABLE (CLIENT_ID INT, " +
                "RATE_HEALTH TEXT, DESCRIBE_HEALTH TEXT, SET_GOAL_FOR_HEALTH TEXT, CHANGED BOOL)";
        ...
        String createSocialProgress = "CREATE TABLE SOCIAL_PROGRESS_TABLE (CLIENT_ID INT, " +
                ...
                "SOCIAL_OUTCOME_DESC TEXT, SOCIAL_GOAL_STATUS_DESC TEXT, CHANGED BOOL)";
        ...
        String createReferral = "CREATE TABLE REFERRAL_TABLE (CLIENT_ID INT, REFERRAL_ID INT, " +
                ...
                "CAN_REPAIR_WHEEL_CHAIR BOOL, OUTCOME TEXT, PHYSIOTHERAPY_PHOTO BLOB, CHANGED BOOL)";
    ...
    public List<ClientInfo> getAllClients() {
        ...
        if(clientCursor.moveToFirst()) {
            do {
                ...
                ClientInfo client = getClientInfoFromCursor(clientCursor);
    ...
    public List<ClientInfo> getChangedAllClients() {

        List<ClientInfo> clientInfoList = new ArrayList<>();

        SQLiteDatabase db = this.getReadableDatabase();

        String query = SELECT_ALL_FROM + CLIENT_TABLE + WHERE_CHANGED_1;
        Cursor clientCursor = db.rawQuery(query, null);
    ...
    public List<ClientDisability> getAllDisability() {
        ...
        if(cursor.moveToFirst()) {
            do {
                ClientDisability client = getClientDisabilityFromCursor(cursor);
    ...
    public List<ClientDisability> getChangedAllDisability() {
        List<ClientDisability> clientDisabilities = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();

        String query = SELECT_ALL_FROM + DISABILITY_TABLE + WHERE_CHANGED_1;
        Cursor cursor = db.rawQuery(query, null);
    ...
    private ClientDisability getClientDisabilityFromCursor(Cursor cursor) {
        ...
        return new ClientDisability(clientId, amputeeDisability,
    ...
    public List<VisitGeneralQuestionSetData> getAllVisitGeneralQuestions() {
        ...
        if(cursor.moveToFirst()) {
            do {
                VisitGeneralQuestionSetData visit = getVisitGeneralQuestionSetDataFromCursor(cursor);
    ...
    public List<VisitGeneralQuestionSetData> getChangedAllVisitGeneralQuestions() {
        List<VisitGeneralQuestionSetData> visitsList = new ArrayList<>();

        SQLiteDatabase db = this.getReadableDatabase();

        String query = SELECT_ALL_FROM + VISIT_TABLE + WHERE_CHANGED_1;
        Cursor cursor = db.rawQuery(query, null);
    ...
    private VisitGeneralQuestionSetData getVisitGeneralQuestionSetDataFromCursor(Cursor cursor) {
        int clientId = cursor.getInt(0);
    ...
    public List<ClientEducationAspect> getAllClientEducationAspects() {
        ...
        if(cursor.moveToFirst()) {
            do {
                ClientEducationAspect client = getClientEducationAspectFromCursor(cursor);
    ...
    public List<ClientEducationAspect> getChangedAllClientEducationAspects() {
        List<ClientEducationAspect> clientList = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();

        String query = SELECT_ALL_FROM + EDUCATION_ASPECT_TABLE + WHERE_CHANGED_1;
        Cursor cursor = db.rawQuery(query, null);
    ...
    private ClientEducationAspect getClientEducationAspectFromCursor(Cursor cursor) {
        int clientId = cursor.getInt(0);
        ...
        return new ClientEducationAspect(clientId, rateEducation,
    ...
    public List<VisitEducationQuestionSetData> getAllVisitEducationQuestions() {
        ...
        if(cursor.moveToFirst()) {
            do {
                VisitEducationQuestionSetData visit = getVisitEducationQuestionSetDataFromCursor(cursor);
    ...
    public List<VisitEducationQuestionSetData> getChangedAllVisitEducationQuestions() {
        ...
        String query = SELECT_ALL_FROM + EDUCATION_PROGRESS_TABLE + WHERE_CHANGED_1;
        Cursor cursor = db.rawQuery(query, null);
    ...
    private VisitEducationQuestionSetData getVisitEducationQuestionSetDataFromCursor(Cursor cursor) {
        int clientId = cursor.getInt(0);
        int visitId = cursor.getInt(1);
    ...
    public List<ClientHealthAspect> getAllClientHealthAspects() {
        ...
        if(cursor.moveToFirst()) {
            do {
                ClientHealthAspect client = getClientHealthAspectFromCursor(cursor);
    ...
    public List<ClientHealthAspect> getChangedAllClientHealthAspects() {
        List<ClientHealthAspect> clientList = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();

        String query = SELECT_ALL_FROM + HEALTH_ASPECT_TABLE + WHERE_CHANGED_1;
        Cursor cursor = db.rawQuery(query, null);
    ...
    private ClientHealthAspect getClientHealthAspectFromCursor(Cursor cursor) {
        int clientId = cursor.getInt(0);
        String rateHealth = cursor.getString(1);
        String describeHealth = cursor.getString(2);
        String setGoalForHealth = cursor.getString(3);

        return new ClientHealthAspect(clientId, rateHealth,
    ...
    public List<VisitHealthQuestionSetData> getAllVisitHealthQuestions() {
        ...
        if(cursor.moveToFirst()) {
            do {
                VisitHealthQuestionSetData visit = getVisitHealthQuestionSetDataFromCursor(cursor);
    ...
    public List<VisitHealthQuestionSetData> getChangedAllVisitHealthQuestions() {
        List<VisitHealthQuestionSetData> visitsList = new ArrayList<>();

        SQLiteDatabase db = this.getReadableDatabase();

        String query = SELECT_ALL_FROM + HEALTH_PROGRESS_TABLE + WHERE_CHANGED_1;
        Cursor cursor = db.rawQuery(query, null);
    ...
    private VisitHealthQuestionSetData getVisitHealthQuestionSetDataFromCursor(Cursor cursor) {
        int clientId = cursor.getInt(0);
        int visitId = cursor.getInt(1);
    ...
    public List<ClientSocialAspect> getAllClientSocialAspects() {
        ...
        if(cursor.moveToFirst()) {
            do {
                ClientSocialAspect client = getClientSocialAspectFromCursor(cursor);
    ...
    public List<ClientSocialAspect> getChangedAllClientSocialAspects() {
        List<ClientSocialAspect> clientList = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();

        String query = SELECT_ALL_FROM + SOCIAL_STATUS_ASPECT_TABLE + WHERE_CHANGED_1;
        Cursor cursor = db.rawQuery(query, null);
    ...
    private ClientSocialAspect getClientSocialAspectFromCursor(Cursor cursor) {
        int clientId = cursor.getInt(0);
        String rateSocial = cursor.getString(1);
        String describeSocial = cursor.getString(2);
        String setGoalForSocial = cursor.getString(3);

        return new ClientSocialAspect(clientId, rateSocial,
    ...
    public List<VisitSocialQuestionSetData> getAllVisitSocialQuestions() {
        ...
        if(cursor.moveToFirst()) {
            do {
                VisitSocialQuestionSetData visit = getVisitSocialQuestionSetDataFromCursor(cursor);
    ...
    public List<VisitSocialQuestionSetData> getChangedAllVisitSocialQuestions() {
        List<VisitSocialQuestionSetData> visitsList = new ArrayList<>();

        SQLiteDatabase db = this.getReadableDatabase();

        String query = SELECT_ALL_FROM + SOCIAL_PROGRESS_TABLE + WHERE_CHANGED_1;
        Cursor cursor = db.rawQuery(query, null);
    ...
    private VisitSocialQuestionSetData getVisitSocialQuestionSetDataFromCursor(Cursor cursor) {
        int clientId = cursor.getInt(0);
        int visitId = cursor.getInt(1);
    ...
    public List<ReferralInfo> getAllReferrals() {
        ...
        if(cursor.moveToFirst()) {
            do {
                ReferralInfo referral = getReferralInfoFromCursor(cursor);
    ...
    public List<ReferralInfo> getChangedReferrals() {
        List<ReferralInfo> referralInfos = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();

        String query = SELECT_ALL_FROM + REFERRAL_TABLE + WHERE_CHANGED_1;
        Cursor cursor = db.rawQuery(query, null);
    ...
    private ReferralInfo getReferralInfoFromCursor(Cursor cursor) {
        int clientId = cursor.getInt(0);
        ...
        return new ReferralInfo(clientId, referralId, requirePhysiotherapy,
